...
def stylize_images(image, filter, alpha_value=128):
    ...
    Меняет формат изображений, создает на их основе новое
    изображение сохраянет его в рабочую директорию.
    """
    ...
    combine_img = os.path.join(settings.DIR_TRANSFER, seconds, f"{seconds}{settings.CONVERT_IMG_TO_FORMAT}")
